...
//Created password object.
var pwdCriteria = {

  //Property for length of password
  pwdLength: 0,

  //array to hold lowercase letters (Im sure there is another way to group but I went the meticulous route)
...
function generatePassword() {
  ...
  while (passwordLength < 8 || passwordLength > 128) {
    ...
    //if user presses cancel it acts as "No"
    ...
    //internal function for prompt the user for criteria
